                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                "${unit[0]['type'][0]
                                    .toUpperCase()}${unit[0]['type'].substring(
                                    1).toLowerCase()}",
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: Theme
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: const Icon(
                                    Icons.bathtub, color: primaryColor,),
                                ),
                                Container(
                                  margin: EdgeInsets.only(left: 3.w, top: 2.h),
                                  child: Text(
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: unit[0]['userInfo']['avatar'] ??
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: Theme
                                        ...
                                        .textTheme
                                        .bodyMedium!
                                        .copyWith(color: unit[0]['has_tv'] == 1
                                        ? primaryColor
                                        : red),
                                  ),
                                ],
